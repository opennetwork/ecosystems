...
export const GeoShapeThing: GeoShapeThingTokenFn = createToken(GeoShapeThingSymbol);export const GeoShapePropertiesSymbol = Symbol("GeoShapeProperties");
...
export const GeoShapeProperties: GeoShapePropertiesTokenFn = createToken(GeoShapePropertiesSymbol);export const GeoShapeSymbol = Symbol("GeoShape");
