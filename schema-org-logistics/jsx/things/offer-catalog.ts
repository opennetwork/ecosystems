...
export const OfferCatalogThing: OfferCatalogThingTokenFn = createToken(OfferCatalogThingSymbol);export const OfferCatalogPropertiesSymbol = Symbol("OfferCatalogProperties");
...
export const OfferCatalogProperties: OfferCatalogPropertiesTokenFn = createToken(OfferCatalogPropertiesSymbol);export const OfferCatalogSymbol = Symbol("OfferCatalog");
