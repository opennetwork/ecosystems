...
export const ImageObjectThing: ImageObjectThingTokenFn = createToken(ImageObjectThingSymbol);
export const ImageObjectPropertiesSymbol = Symbol("ImageObjectProperties");
...
export const ImageObjectProperties: ImageObjectPropertiesTokenFn = createToken(ImageObjectPropertiesSymbol);
export const ImageObjectSymbol = Symbol("ImageObject");
