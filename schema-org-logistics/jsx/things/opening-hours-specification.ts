...
export const OpeningHoursSpecificationThing: OpeningHoursSpecificationThingTokenFn = createToken(OpeningHoursSpecificationThingSymbol);
export const OpeningHoursSpecificationSymbol = Symbol("OpeningHoursSpecification");
