...
export const ContactPointOptionThing: ContactPointOptionThingTokenFn = createToken(ContactPointOptionThingSymbol);
export const ContactPointOptionSymbol = Symbol("ContactPointOption");
