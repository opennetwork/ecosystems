...
export const ProductModelThing: ProductModelThingTokenFn = createToken(ProductModelThingSymbol);
export const ProductModelPropertiesSymbol = Symbol("ProductModelProperties");
...
export const ProductModelProperties: ProductModelPropertiesTokenFn = createToken(ProductModelPropertiesSymbol);
export const ProductModelSymbol = Symbol("ProductModel");
