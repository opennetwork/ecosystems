...
export const DemandThing: DemandThingTokenFn = createToken(DemandThingSymbol);
export const DemandPropertiesSymbol = Symbol("DemandProperties");
...
export const DemandProperties: DemandPropertiesTokenFn = createToken(DemandPropertiesSymbol);
export const DemandSymbol = Symbol("Demand");
