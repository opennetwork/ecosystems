...
export const BusinessFunctionThing: BusinessFunctionThingTokenFn = createToken(BusinessFunctionThingSymbol);export const BusinessFunctionSymbol = Symbol("BusinessFunction");
