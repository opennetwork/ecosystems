...
export const FinancialProductThing: FinancialProductThingTokenFn = createToken(FinancialProductThingSymbol);export const FinancialProductPropertiesSymbol = Symbol("FinancialProductProperties");
...
export const FinancialProductProperties: FinancialProductPropertiesTokenFn = createToken(FinancialProductPropertiesSymbol);export const FinancialProductSymbol = Symbol("FinancialProduct");
