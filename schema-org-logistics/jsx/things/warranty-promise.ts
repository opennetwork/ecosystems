...
export const WarrantyPromiseThing: WarrantyPromiseThingTokenFn = createToken(WarrantyPromiseThingSymbol);
export const WarrantyPromisePropertiesSymbol = Symbol("WarrantyPromiseProperties");
...
export const WarrantyPromiseProperties: WarrantyPromisePropertiesTokenFn = createToken(WarrantyPromisePropertiesSymbol);
export const WarrantyPromiseSymbol = Symbol("WarrantyPromise");
