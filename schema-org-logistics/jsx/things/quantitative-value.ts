...
export const QuantitativeValueThing: QuantitativeValueThingTokenFn = createToken(QuantitativeValueThingSymbol);export const QuantitativeValuePropertiesSymbol = Symbol("QuantitativeValueProperties");
...
export const QuantitativeValueProperties: QuantitativeValuePropertiesTokenFn = createToken(QuantitativeValuePropertiesSymbol);export const QuantitativeValueSymbol = Symbol("QuantitativeValue");
