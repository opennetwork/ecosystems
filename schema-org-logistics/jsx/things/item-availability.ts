...
export const ItemAvailabilityThing: ItemAvailabilityThingTokenFn = createToken(ItemAvailabilityThingSymbol);export const ItemAvailabilityPropertiesSymbol = Symbol("ItemAvailabilityProperties");
...
export const ItemAvailabilityProperties: ItemAvailabilityPropertiesTokenFn = createToken(ItemAvailabilityPropertiesSymbol);export const ItemAvailabilitySymbol = Symbol("ItemAvailability");
