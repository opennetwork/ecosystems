...
export const WarrantyScopeThing: WarrantyScopeThingTokenFn = createToken(WarrantyScopeThingSymbol);
export const WarrantyScopePropertiesSymbol = Symbol("WarrantyScopeProperties");
...
export const WarrantyScopeProperties: WarrantyScopePropertiesTokenFn = createToken(WarrantyScopePropertiesSymbol);
export const WarrantyScopeSymbol = Symbol("WarrantyScope");
