...
export const OfferItemConditionThing: OfferItemConditionThingTokenFn = createToken(OfferItemConditionThingSymbol);
export const OfferItemConditionSymbol = Symbol("OfferItemCondition");
