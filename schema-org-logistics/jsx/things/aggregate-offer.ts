...
export const AggregateOfferThing: AggregateOfferThingTokenFn = createToken(AggregateOfferThingSymbol);export const AggregateOfferSymbol = Symbol("AggregateOffer");
