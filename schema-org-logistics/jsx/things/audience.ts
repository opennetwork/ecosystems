...
export const AudienceThing: AudienceThingTokenFn = createToken(AudienceThingSymbol);
export const AudiencePropertiesSymbol = Symbol("AudienceProperties");
...
export const AudienceProperties: AudiencePropertiesTokenFn = createToken(AudiencePropertiesSymbol);
export const AudienceSymbol = Symbol("Audience");
