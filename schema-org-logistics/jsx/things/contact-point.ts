...
export const ContactPointThing: ContactPointThingTokenFn = createToken(ContactPointThingSymbol);export const ContactPointPropertiesSymbol = Symbol("ContactPointProperties");
...
export const ContactPointProperties: ContactPointPropertiesTokenFn = createToken(ContactPointPropertiesSymbol);export const ContactPointSymbol = Symbol("ContactPoint");
