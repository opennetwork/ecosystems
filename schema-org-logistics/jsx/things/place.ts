...
export const PlaceThing: PlaceThingTokenFn = createToken(PlaceThingSymbol);export const PlacePropertiesSymbol = Symbol("PlaceProperties");
...
export const PlaceProperties: PlacePropertiesTokenFn = createToken(PlacePropertiesSymbol);export const PlaceSymbol = Symbol("Place");
