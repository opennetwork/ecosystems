...
export const DeliveryMethodThing: DeliveryMethodThingTokenFn = createToken(DeliveryMethodThingSymbol);
export const DeliveryMethodSymbol = Symbol("DeliveryMethod");
