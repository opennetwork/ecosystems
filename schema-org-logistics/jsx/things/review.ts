...
export const ReviewThing: ReviewThingTokenFn = createToken(ReviewThingSymbol);
export const ReviewPropertiesSymbol = Symbol("ReviewProperties");
...
export const ReviewProperties: ReviewPropertiesTokenFn = createToken(ReviewPropertiesSymbol);
export const ReviewSymbol = Symbol("Review");
