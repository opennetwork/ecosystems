...
export const LoanOrCreditThing: LoanOrCreditThingTokenFn = createToken(LoanOrCreditThingSymbol);
export const LoanOrCreditPropertiesSymbol = Symbol("LoanOrCreditProperties");
...
export const LoanOrCreditProperties: LoanOrCreditPropertiesTokenFn = createToken(LoanOrCreditPropertiesSymbol);
export const LoanOrCreditSymbol = Symbol("LoanOrCredit");
